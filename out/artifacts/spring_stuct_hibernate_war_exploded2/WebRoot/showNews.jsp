        ...
        <div class="col-lg-offset-2 domain-part col-lg-8">
            <section>
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <s:form action="likeShowAction">
                        <s:select name="id" list="categories" listKey="id" listValue="categoryName" headerKey="0" headerValue="--请选择类型--"/>
                        <s:submit value="查看新闻"/>
                    </s:form>
                    <table align="center" border="2" cellspacing="0">
                        ...
                        <s:iterator value="newsList" var="news">
                            <tr>
                                ...
                                <td><s:a href="getNewsIdAction.action?id=%{#news.id}"><s:property value="#news.title"/></s:a></td>
                                <td><s:property value="#news.issue"/> </td>
                                <td><s:property value="#news.categoryName"/> </td>
                                <td><s:a href="getNewsIdAction.action?id=%{#news.id}">修改</s:a>    <s:a href="deleteNewsAction.action?id=%{#news.id}">删除</s:a> </td>
